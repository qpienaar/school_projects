function [c, ceq, dcdx, dceqdx] = WingConstraints(x, L, E, force, yield, Nelem, fnom, xspan, pts)
...
%   pts - number of GHQ points to use
% Outputs:
...
for k = 1:2*(Nelem+1)
    ...
    function cineq = CalcInequality(x)
        ...
        [mu, stdv] = calc_statistic(fnom, xspan, L, E, Iyy, force, Nelem, r_out, pts);
