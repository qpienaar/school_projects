...
This section contains coursework and projects completed in the field of Computational Engineering at Rensselaer Polytechnic Institute. Projects span scientific machine learning, parallel and high performance computing, numerical design optimization, and computational fluid dynamics, and are implemented primarily in Python, MATLAB and C/CUDA. Work ranges from training neural networks for path planning, parallel stencil algorithms on RPI's AiMOS supercomputing cluster, thermal analysis of Tokomak reactor cooling systems, and the optimization of a wing spar for uncertain loading.
